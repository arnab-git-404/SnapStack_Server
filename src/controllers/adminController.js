    ...
    res.status(200).json({
      ...
      stats: {
        ...
        memory: {
          ...
          usedMemoryPercentage: `${(((totalMemory - freeMemory) / totalMemory) * 100).toFixed(2)}%`
        },
        cpu: {
          usage: `${cpuUsage}%`,
          cores: cpus.length,
...
//     user.isActivated = isActivated !== undefined ? isActivated : !user.isActivated;
//     await user.save();
...
module.exports = { getAllUsers, getServerStats, toggleUserActivation };